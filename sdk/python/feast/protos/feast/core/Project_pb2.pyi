...
class ProjectSpec(_message.Message):
    ...
    group: _builtins.str
    """Group of the Project (for multi-tenant scenarios)"""
    @_builtins.property
    ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["description", b"description", "group", b"group", "name", b"name", "owner", b"owner", "tags", b"tags"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
